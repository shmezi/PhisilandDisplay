!function (e, t) {
    ...
    "use strict";
    var e = navigator.userAgent, l = navigator.platform, d = /gecko\/\d/i.test(e), s = /MSIE \d/.test(e),
        a = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(e), u = /Edge\/(\d+)/.exec(e), w = s || a || u,
        v = w && (s ? document.documentMode || 6 : +(u || a)[1]), x = !u && /WebKit\//.test(e),
        s = x && /Qt\/\d+\.\d+/.test(e), m = !u && /Chrome\/(\d+)/.exec(e), V = m && +m[1], K = /Opera\//.test(e),
        j = /Apple Computer/.test(navigator.vendor), c = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(e),
        X = /PhantomJS/.test(e), Y = j && (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints),
        $ = /Android/.test(e), _ = Y || $ || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
        C = Y || /Mac/.test(l), q = /\bCrOS\b/.test(e), a = /win/i.test(l), u = K && e.match(/Version\/(\d*\.\d*)/),
    ...
    var ee = function (e, t) {
        var n, r = e.className, t = J(t).exec(r);
    ...
    }, me = {origin: "*mouse"}, ve = {origin: "+move"};
    ...
    var Fe, Pe, Ee, Ie, ze, Re = function (e, t) {
        ...
        for (var L = 0; L < i; ++L) if (Pe.test(o[L])) {
            for (var k = void 0, k = L + 1; k < i && Pe.test(o[k]); ++k) ;
            for (var T = "L" == (L ? o[L - 1] : n), M = T == ("L" == (k < i ? o[k] : n)) ? T ? "L" : "R" : n, N = L; N < k; ++N) o[N] = M;
            L = k - 1
        }
        for (var O, A = [], D = 0; D < i;) if (Ie.test(o[D])) {
            var E = D;
            for (++D; D < i && Ie.test(o[D]); ++D) ;
            A.push(new Be(0, E, D))
        } else {
            var W = D, H = A.length, F = "rtl" == t ? 1 : 0;
            for (++D; D < i && "L" != o[D]; ++D) ;
            for (var P = W; P < D;) if (ze.test(o[P])) {
    ...
    function Ke(e) {
        ...
        if (t) for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r) -1 == L(n, t[r]) && n.push(t[r])
    }
    ...
    var tt = 3 != "\n\nb".split(/\n/).length ? function (e) {
            for (var t = 0, n = [], r = e.length; t <= r;) {
                var i = e.indexOf("\n", t),
                    o = (-1 == i && (i = e.length), e.slice(t, "\r" == e.charAt(i - 1) ? i - 1 : i)), l = o.indexOf("\r");
    ...
    function H(e) {
        ...
        for (var t = e.parent, n = L(t.lines, e), r = t.parent; r; r = (t = r).parent) for (var i = 0; r.children[i] != t; ++i) n += r.children[i].chunkSize();
        return n + t.first
    }
    ...
    function Dt(e, t, n, r) {
        var i = e.doc.mode, o = new g(t, e.options.tabSize, n);
    ...
    function Pt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = W(l, (t = E(l, t)).line), u = At(e, t.line, n),
            c = new g(a.text, e.options.tabSize, u);
        for (r && (o = []); (r || c.pos < t.ch) && !c.eol();) c.start = c.pos, i = Ht(s, c, u.state), r && o.push(new Ft(c, i, ht(l.mode, u.state)));
    ...
    function It(e, t, n, r, i, o, l) {
        var s = n.flattenSpans, a = (null == s && (s = e.options.flattenSpans), 0), u = null,
            c = new g(t, e.options.tabSize, r), h = e.options.addModeClass && [null];
        for ("" == t && Et(Wt(n, r.state), o); !c.eol();) {
            var d,
                f = c.pos > e.options.maxHighlightLength ? (s = !1, l && Dt(e, t, r, c.pos), c.pos = t.length, null) : Et(Ht(n, c, r.state, h), o);
    ...
    function Ut(e, t) {
        ...
        if (!n && !e) return null;
        var r = t.from.ch, i = t.to.ch, o = 0 == P(t.from, t.to), l = function (e, t, n) {
            var r;
            ...
            return r
        }(e, i, o), a = 1 == t.text.length, u = z(t.text).length + (a ? r : 0);
        ...
        if (!a) {
            ...
            if (0 < v && l) for (var y = 0; y < l.length; ++y) null == l[y].to && (m = m || []).push(new Bt(l[y].marker, null, null));
    ...
    function $t(e, t) {
        ...
        if (0 != n) return n;
        var n = e.find(), r = t.find(), i = P(n.from, r.from) || Xt(e) - Xt(t);
        if (i) return -i;
    ...
    function _t(e, t) {
        ...
        if (r) for (var i, o = 0; o < r.length; ++o) (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || $t(n, i.marker) < 0) && (n = i.marker);
        return n
    }
    ...
    function Qt(e, t, n, r, i) {
        var e = W(e, t), o = Rt && e.markedSpans;
        if (o) for (var l = 0; l < o.length; ++l) {
            var s = o[l];
            if (s.marker.collapsed) {
                var a = s.marker.find(0), u = P(a.from, n) || Xt(s.marker) - Xt(i),
    ...
    function on(e) {
        ...
        for (r = e; t = Zt(r);) var o = t.find(0, !0), n = (n -= r.text.length - o.from.ch) + ((r = o.to.line).text.length - o.to.ch);
        return n
    }
    ...
    function hn(e, t) {
        var n = ne("span", null, null, x ? "padding-right: .1px" : null), r = {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            var o = i ? t.rest[i - 1] : t.line, l = void 0, l = (r.pos = 0, r.addToken = fn, function (e) {
                if (null != Je) return Je;
                var t = y(e, document.createTextNode("AخA")), n = le(t, 0, 1).getBoundingClientRect(),
            ...
            !function (e, t, n) {
                ...
                if (r) for (var l, s, a, u, c, h, d, f = i.length, p = 0, g = 1, m = "", v = 0; ;) {
                    if (v == p) {
                        ...
                        for (var y = [], b = void 0, w = 0; w < r.length; ++w) {
                            ...
                            if ("bookmark" == C.type && x.from == p && C.widgetNode) y.push(C); else if (x.from <= p && (null == x.to || x.to > p || C.collapsed && x.to == p && x.from == p)) {
                                if (null != x.to && x.to != p && v > x.to && (v = x.to, u = ""), C.className && (a += " " + C.className), C.css && (s = (s ? s + ";" : "") + C.css), C.startStyle && x.from == p && (c += " " + C.startStyle), C.endStyle && x.to == v && (b = b || []).push(C.endStyle, x.to), C.title && ((d = d || {}).title = C.title), C.attributes) for (var S in C.attributes) (d = d || {})[S] = C.attributes[S];
                                C.collapsed && (!h || $t(h.marker, C) < 0) && (h = x)
                            } else x.from > p && v > x.from && (v = x.from)
                        }
                        if (b) for (var L = 0; L < b.length; L += 2) b[L + 1] == v && (u += " " + b[L]);
                        if (!h || h.from == p) for (var k = 0; k < y.length; ++k) pn(t, 0, y[k]);
                        if (h && (h.from || 0) == p) {
                ...
                } else for (var O = 1; O < n.length; O += 2) t.addToken(t, i.slice(o, o = n[O]), cn(n[O + 1], t.cm.options))
    ...
    function fn(e, t, n, r, i, o, l) {
        if (t) {
            ...
            if (a.test(t)) for (var c = document.createDocumentFragment(), h = 0; ;) {
                a.lastIndex = h;
            ...
            if (e.trailingSpace = 32 == s.charCodeAt(t.length - 1), n || r || i || u || o || l) {
                var u = n || "", g = (r && (u += r), i && (u += i), M("span", [c], u, o));
    ...
    function mn(e, t, n) {
        for (var r = [], i = t; i < n; i = l) {
            var o = new gn(e.doc, W(e.doc, i), i), l = i + o.size;
            r.push(o)
        }
        return r
    }
    ...
    function b(e, t) {
        var n = Ve(e, t);
        if (n.length) for (var r, i = Array.prototype.slice.call(arguments, 2), o = (vn ? r = vn.delayedCallbacks : yn ? r = yn : (r = yn = [], setTimeout(bn, 0)), 0); o < n.length; ++o) !function (e) {
            r.push(function () {
    ...
    function wn(e, t, n, r) {
        for (var i = 0; i < t.changes.length; i++) {
            ...
            if ("text" == o) {
                u = a = s = l = void 0;
                var l = e, s = t, a = s.text.className, u = Cn(l, s);
            ...
            } else if ("gutter" == o) Ln(e, t, n, r); else if ("class" == o) Sn(e, t); else if ("widget" == o) {
                f = d = h = l = c = u = void 0;
                var u = e, c = t, l = r;
    ...
    function Ln(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (l.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(l), o.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", bt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), i) for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
    ...
    function Tn(e, t, n, r, i) {
        if (t.widgets) for (var o = xn(n), l = 0, s = t.widgets; l < s.length; ++l) {
            var a = s[l], u = M("div", [a.node], "CodeMirror-linewidget" + (a.className ? " " + a.className : "")),
    ...
    function Nn(e, t) {
        for (var n = qe(t); n != e.wrapper; n = n.parentNode) if (!n || 1 == n.nodeType && "true" == n.getAttribute("cm-ignore-events") || n.parentNode == e.sizer && n != e.mover) return 1
    }
    ...
    function Pn(e, t, n) {
        ...
        if (e.rest) {
            ...
            for (var i = 0; i < e.rest.length; i++) if (H(e.rest[i]) > n) return {
    ...
    function zn(e, t) {
        ...
        return {line: t, view: o, rect: null, map: e.map, cache: e.cache, before: e.before, hasHeights: !1}
    }

    function Rn(e, t, n, r, i) {
        var o, l = (n = t.before ? -1 : n) + (r || "");
        if (t.cache.hasOwnProperty(l)) o = t.cache[l]; else {
            if (t.rect || (t.rect = t.view.text.getBoundingClientRect()), !t.hasHeights) {
                var s = e, a = t.view, u = t.rect, c = s.options.lineWrapping, s = c && Hn(s);
            ...
            (o = function (e, t, n, r) {
                var i, o = Un(t.map, n, r), l = o.node, s = o.start, a = o.end, u = o.collapse;
                if (3 == l.nodeType) {
                    for (var c = 0; c < 4; c++) {
                    ...
                    w && v < 11 && (i = function (e, t) {
                        ...
                        var e = screen.logicalXDPI / screen.deviceXDPI, n = screen.logicalYDPI / screen.deviceYDPI;
                        return {left: t.left * e, right: t.right * e, top: t.top * n, bottom: t.bottom * n}
                    }(e.display.measure, i))
        ...
        return {left: o.left, right: o.right, top: i ? o.rtop : o.top, bottom: i ? o.rbottom : o.bottom}
    }

    var Bn, Gn = {left: 0, right: 0, top: 0, bottom: 0};

    function Un(e, t, n) {
        for (var r, i, o, l, s, a, u = 0; u < e.length; u += 3) if (s = e[u], a = e[u + 1], t < s ? (i = 0, o = 1, l = "left") : t < a ? o = (i = t - s) + 1 : (u == e.length - 3 || t == a && e[u + 3] > t) && (i = (o = a - s) - 1, a <= t && (l = "right")), null != i) {
    ...
    function Qn(n, e, r, i, o, l) {
        ...
        var a = Ge(i, n.doc.direction), t = e.ch, e = e.sticky;
        ...
        var c = He(a, t, e), h = We, c = u(t, c, "before" == e);
        return null != h && (c.other = u(t, h, "before" != e)), c
    }

    function Jn(e, t) {
        var n = 0, t = (t = E(e.doc, t), e.options.lineWrapping || (n = ar(e.display) * t.ch), W(e.doc, t.line)),
            e = rn(t) + On(e.display);
    ...
    function tr(e, t, n) {
        ...
        for (var l = W(r, i); ;) {
            var s = function (n, e, t, r, i) {
                i -= rn(e);
                var o = zn(n, e), l = $n(e), s = 0, a = e.text.length, u = !0, c = Ge(e, n.doc.direction);
                c && (c = (n.options.lineWrapping ? lr : or)(n, e, t, o, c, r, i), u = 1 != c.level, s = u ? c.from : c.to - 1, a = u ? c.to : c.from - 1);
                var h = null, d = null, c = De(function (e) {
                    var t = Rn(n, o, e);
    ...
    function nr(t, e, n, r) {
        r -= $n(e);
        var e = e.text.length, i = De(function (e) {
            return Rn(t, n, e - 1).bottom <= r
        }, e, 0);
        return {
            begin: i, end: De(function (e) {
    ...
    function lr(e, t, n, r, i, o, l) {
        ...
        return u = (u = (u = u || i[i.length - 1]).from < s ? {
            ...
            to: u.to,
            level: u.level
        } : u).to > a ? {from: u.from, to: a, level: u.level} : u
    }
    ...
    function ar(e) {
        ...
        var t = M("span", "xxxxxxxxxx"), n = M("pre", [t], "CodeMirror-line-like"),
            n = (y(e.measure, n), t.getBoundingClientRect()), t = (n.right - n.left) / 10;
    ...
    function hr(r) {
        var i = sr(r.display), o = r.options.lineWrapping,
    ...
    function vr(e, t, n, r) {
        var i, o = pr(e, t), l = e.display.view;
    ...
    function wr(e, t) {
        void 0 === t && (t = !0);
        var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(),
            o = r.selection = document.createDocumentFragment(), l = e.options.$customCursor;
        l && (t = !0);
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++) !t && c == n.sel.primIndex || ((s = n.sel.ranges[c]).from().line >= e.display.viewTo || s.to().line < e.display.viewFrom || (a = s.empty(), l ? (u = l(e, s)) && xr(e, u, i) : (a || e.options.showCursorWhenSelecting) && xr(e, s.head, i), a || function (i, e, t) {
            var n = i.display, o = i.doc, l = document.createDocumentFragment(), r = Dn(i.display), S = r.left,
                L = Math.max(n.sizerWidth, Hn(i) - n.sizer.offsetLeft) - r.right, k = "ltr" == o.direction;
            ...
            function s(n, g, m) {
                var v, y, r = W(o, n), b = r.text.length;
                ...
                return function (e, t, n, r) {
                    ...
                    var i, o, l, s, a, u = "ltr" == n, c = w(e, u ? "left" : "right"),
                        h = w(t - 1, u ? "right" : "left"), d = null == g && 0 == e, f = null == m && t == b,
                        p = 0 == r, r = !C || r == C.length - 1;
    ...
    function Nr(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0; l < t.view.length; l++) {
            var s = t.view[l], a = e.options.lineWrapping, u = void 0, c = 0;
            if (!s.hidden) {
                ...
                if ((.005 < a || a < -.005) && (i < r && (o -= a), mt(s.line, u), Or(s.line), s.rest)) for (var d = 0; d < s.rest.length; d++) Or(s.rest[d]);
    ...
    function Ar(e, t, n) {
        var r, i = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop, i = Math.floor(i - On(e)),
            o = n && null != n.bottom ? n.bottom : i + e.wrapper.clientHeight, i = vt(t, i), o = vt(t, o);
    ...
    function Dr(e, t) {
        var n = e.display, r = sr(e.display),
            i = (t.top < 0 && (t.top = 0), (e.curOp && null != e.curOp.scrollTop ? e.curOp : n.scroller).scrollTop),
            o = Fn(e), l = {}, s = (t.bottom - t.top > o && (t.bottom = t.top + o), e.doc.height + An(n)),
            a = t.top < r, r = t.bottom > s - r,
            ...
            o = Hn(e) - n.gutters.offsetWidth, i = t.right - t.left > o;
    ...
    function Ir(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (d || ti(e, {top: t}), zr(e, t, !0), d && ti(e), qr(e, 100))
    }
    ...
    function Br(e) {
        var t = e.display, n = t.gutters.offsetWidth, r = Math.round(e.doc.height + An(e.display));
        return {
    ...
    function $r(e) {
        e.curOp = {
            ...
            id: ++Yr,
            markArrays: null
        }, e = e.curOp, vn ? vn.ops.push(e) : e.ownsGroup = vn = {ops: [e], delayedCallbacks: []}
    }
        ...
        if (e) {
            var t = function (e) {
                ...
                for (var v, y = 0; y < n.length; y++) {
                    ...
                    T = void 0;
                    var b = n[y];
                    var w = b.cm, x = w.display, C = w.doc;
                    ...
                    var S = b.maybeHiddenMarkers, L = b.maybeUnhiddenMarkers;
                    if (S) for (var k = 0; k < S.length; ++k) S[k].lines.length || O(S[k], "hide");
                    if (L) for (var T = 0; T < L.length; ++T) L[T].lines.length && O(L[T], "unhide");
            ...
            if (e = e.ownsGroup) try {
                var n = e, r = n.delayedCallbacks, i = 0;
                do {
                    for (; i < r.length; i++) r[i].call(null);
                    for (var o = 0; o < n.ops.length; o++) {
                        var l = n.ops[o];
                        if (l.cursorActivityHandlers) for (; l.cursorActivityCalled < l.cursorActivityHandlers.length;) l.cursorActivityHandlers[l.cursorActivityCalled++].call(null, l.cm)
                    }
                } while (i < r.length)
            } finally {
                vn = null, t(e)
    ...
    function Jr(e, t) {
        ...
        var l = function (e) {
            ...
            }(e), s = (4 < i && (n.lineDiv.style.display = "none"), e), a = n.updateLineNumbers, u = t.dims, c = s.display,
            h = s.options.lineNumbers, d = c.lineDiv, f = d.firstChild;
        ...
        for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
            var y = g[v];
            if (!y.hidden) if (y.node && y.node.parentNode == d) {
                for (; f != y.node;) f = p(f);
    ...
    function ei(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            if (r && e.options.lineWrapping && t.oldDisplayWidth != Hn(e)) r && (t.visible = Ar(e.display, e.doc, n)); else if (n && null != n.top && (n = {top: Math.min(e.doc.height + An(e.display) - Fn(e), n.top)}), t.visible = Ar(e.display, e.doc, n), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo) break;
            if (!Jr(e, t)) break;
            Nr(e);
            var i = Br(e);
    ...
    function ii(e) {
        ...
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var r = cr(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", l = 0; l < n.length; l++) if (!n[l].hidden) {
    ...
    function si(e) {
        ...
        for (var r = 0; r < n.length; ++r) {
            var i = n[r], o = i.className, i = i.style, l = t.appendChild(M("div", null, "CodeMirror-gutter " + o));
    ...
    function pi(e, t) {
        ...
        var n = di(t), r = n.x, n = n.y, i = hi,
            o = (0 === t.deltaMode && (r = t.deltaX, n = t.deltaY, i = 1), e.display), l = o.scroller,
            s = l.scrollWidth > l.clientWidth, a = l.scrollHeight > l.clientHeight;
        if (r && s || n && a) {
            if (n && C && x) e:for (var u = t.target, c = o.view; u != l; u = u.parentNode) for (var h = 0; h < c.length; h++) if (c[h].node == u) {
    ...
    function gi(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            var o, l = t[i], s = t[i - 1], a = P(s.to(), l.from());
    ...
    function Li(e, o, t, l) {
        ...
        var s, a = o.from, u = o.to, c = o.text, h = W(e, a.line), d = W(e, u.line), f = z(c), p = i(c.length - 1),
            g = u.line - a.line;
    ...
    function Ii(e, t, n) {
        for (var r = [], i = 0; i < e.length; ++i) {
            var o = e[i];
            if (o.ranges) r.push(n ? B.prototype.deepCopy.call(o) : o); else {
                var l = o.changes, s = [];
                r.push({changes: s});
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        to: c.to,
                        text: c.text
                    }), t) for (var h in c) (u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && (z(s)[h] = c[h], delete c[h])
                }
            }
        }
        return r
    ...
    function Yi(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            var l = t.ranges[o], s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
                a = _i(e, l.anchor, s && s.anchor, n, r), s = l.head == l.anchor ? a : _i(e, l.head, s && s.head, n, r);
    ...
    function $i(e, t, n, r, i) {
        ...
        if (o.markedSpans) for (var l = 0; l < o.markedSpans.length; ++l) {
            var s = o.markedSpans[l], a = s.marker, u = "selectLeft" in a ? !a.selectLeft : a.inclusiveLeft,
    ...
    function Ji(e, t, n) {
        ...
        if (!(je(e, "beforeChange") || e.cm && je(e.cm, "beforeChange")) || (t = Qi(e, t, !0))) {
            ...
            if (r) for (var i = r.length - 1; 0 <= i; --i) eo(e, {
                from: r[i].from,
                to: r[i].to,
                text: i ? [""] : t.text,
                origin: t.origin
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                for (n.lastOrigin = n.lastSelOrigin = null; ;) {
                    ...
                    if (Hi(l, a), e && !l.equals(i.sel)) return void U(i, l, {clearRedo: !1});
                    r = l
                }
                for (var c = [], h = (Hi(r, a), a.push({
                    ...
                    var f = function (e) {
                        ...
                        c.push(Oi(i, n));
                        var t = e ? bi(i, n) : z(s), r = (ro(i, n, t, Ei(i, n)), !e && i.cm && i.cm.scrollIntoView({
                            from: n.from,
                            to: vi(n)
                        }), []);
                        ki(i, function (e, t) {
    ...
    function ro(e, t, n, r) {
        ...
        if (t.to.line < e.first) no(e, t.text.length - 1 - (t.to.line - t.from.line)); else if (!(t.from.line > e.lastLine())) {
            ...
            if ((t = t.to.line > i ? {
                ...
                var i = e.cm, o = t, l = r, s = i.doc, a = i.display, u = o.from, c = o.to, h = !1, d = u.line,
                    ...
                    }), h && (i.curOp.updateMaxLine = !0)), s), p = u.line;
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var a = 0; a < o.changes.length; ++a) {
                    var u = o.changes[a];
                    if (n < u.from.line) u.from = F(u.from.line + r, u.from.ch), u.to = F(u.to.line + r, u.to.ch); else if (t <= u.to.line) {
                        l = !1;
                        break
                    }
                }
    ...
    ho.prototype.clear = function () {
        var e = this.doc.cm, t = this.line.widgets, n = this.line, r = H(n);
        if (null != r && t) {
        ...
        var e = this, t = this.height, n = this.doc.cm, r = this.line, i = (this.height = null, Mn(this) - t);
    ...
    function mo(r, i, o, e, t) {
        ...
        if (r.iter(g, o.line + 1, function (e) {
            ...
            if (p && (m.curOp.updateMaxLine = !0), d.collapsed) I(m, i.line, o.line + 1); else if (d.className || d.startStyle || d.endStyle || d.css || d.attributes || d.title) for (var v = i.line; v <= o.line; v++) gr(m, v, "text");
    ...
    po.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            for (var e, t = this.doc.cm, n = t && !t.curOp, r = (n && $r(t), !je(this, "clear") || (e = this.find()) && b(this, "clear", e.from, e.to), null), i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o], s = Gt(l.markedSpans, this);
            ...
            if (t && this.collapsed && !t.options.lineWrapping) for (var a = 0; a < this.lines.length; ++a) {
                var u = Jt(this.lines[a]), c = on(u);
        ...
        for (var i = 0; i < this.lines.length; ++i) {
            var o = this.lines[i], l = Gt(o.markedSpans, this);
        ...
        r && o && h(o, function () {
            var e = r.line, t = H(r.line), t = In(o, t);
    ...
    var wo = 0, xo = ((f.prototype = Se(co.prototype, {
        constructor: f, iter: function (e, t, n) {
            ...
            var t = F(this.first, 0), n = this.first + this.size - 1;
            Ji(this, {
                from: t,
        ...
        }, getLineNumber: H, getLineHandleVisualStart: function (e) {
            ...
            for (var t = this.sel.ranges, n = 0; n < t.length; n++) var r = pt(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
            ...
            for (var t = t && "end" != t && function (e, t, n) {
                for (var r = [], i = u = F(e.first, 0), o = 0; o < t.length; o++) {
                    var l = t[o], s = wi(l.from, u, i), a = wi(vi(l), u, i), u = l.to, i = a;
            ...
            return {done: Ii(this.history.done), undone: Ii(this.history.undone)}
            ...
            var t = [], n = W(this, (e = E(this, e)).line).markedSpans;
            ...
            for (var t = this.first, n = this.first + this.size, n = (null != (e = e || {}).from && e.from > t && (t = e.from), null != e.to && e.to < n && (n = e.to), new f(gt(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction)), r = (e.sharedHist && (n.history = this.history), (this.linked || (this.linked = [])).push({
                ...
                var l = i[o], s = l.find(), a = r.clipPos(s.from), s = r.clipPos(s.to);
                P(a, s) && (a = mo(r, a, s, l.primary, l.primary.type), l.markers.push(a), a.parent = l)
            }
            return n
        }, unlinkDoc: function (e) {
            if (e instanceof p && (e = e.doc), this.linked) for (var t = 0; t < this.linked.length; ++t) {
                var n = this.linked[t];
                if (n.doc == e) {
    ...
    function Co(e) {
        ...
        if (So(r), !A(r, e) && !Nn(r.display, e)) {
            D(e), w && (xo = +new Date);
            var t = fr(r, e, !0), n = e.dataTransfer.files;
            if (t && !r.isReadOnly()) if (n && n.length && window.FileReader && window.File) for (var i = n.length, o = Array(i), l = 0, s = function () {
                ++l == i && R(r, function () {
                    var e = {
                        from: t = E(r.doc, t), to: t, text: r.doc.splitLines(o.filter(function (e) {
                            return null != e
                        }).join(r.doc.lineSeparator())), origin: "paste"
                    };
                ...
                try {
                    ...
                    if (c) {
                        if (r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()), Ki(r.doc, mi(t, t)), u) for (var h = 0; h < u.length; ++h) io(r.doc, "", u[h].anchor, u[h].head, "drag");
    ...
    function Fo(e) {
        ...
        for (t in e) if (e.hasOwnProperty(t)) {
            var i = e[t];
            if (!/^(name|fallthrough|(de|at)tach)$/.test(t)) if ("..." == i) delete e[t]; else {
    ...
    function Ko(t, n, s, e) {
        ...
        var r = He(a, s.ch, s.sticky), i = a[r];
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || zn(t, n), rr(t, n, l, e)) : {begin: 0, end: n.text.length}
        }
    ...
    var jo = {
        selectAll: Zi, singleSelection: function (e) {
            ...
            return Bo(n, function (e) {
                ...
                } : {from: e.head, to: F(e.head.line, t)}) : {from: e.from(), to: e.to()}
            })
        }, deleteLine: function (t) {
            return Bo(t, function (e) {
                return {from: F(e.from().line, 0), to: E(t.doc, F(e.to().line + 1, 0))}
            })
            ...
            return i.extendSelectionsBy(function (e) {
                var t = i, e = e.head.line, n = W(t.doc, e), r = function (e) {
            ...
            return t.extendSelectionsBy(function (e) {
                ...
                return t.coordsChar({left: t.display.lineDiv.offsetWidth + 100, top: e}, "div")
            }, ve)
            ...
            return n.extendSelectionsBy(function (e) {
                var t = n.cursorCoords(e.head, "div").top + 5, t = n.coordsChar({left: 0, top: t}, "div");
            ...
            for (var t = [], n = e.listSelections(), r = e.options.tabSize, i = 0; i < n.length; i++) {
                var o = n[i].from(), o = S(e.getLine(o.line), o.ch, r);
                t.push(we(r - o % r))
            }
    ...
    function Xo(e, t) {
        var n = W(e.doc, t), r = Jt(n);
        return Vo(!0, e, r, t = r != n ? H(r) : t, 1)
    }

    function Yo(e, t) {
        var n = Xo(e, t.line), r = W(e.doc, n.line), e = Ge(r, e.doc.direction);
    ...
    function ll(e) {
        var t, n, r, i, o, l, s, a, u, c = this, h = c.display;
        A(c, e) || h.activeTouch && h.input.supportsTouch() || (h.input.ensurePolled(), h.shift = e.shiftKey, Nn(h, e) ? x || (h.scroller.draggable = !1, setTimeout(function () {
            ...
            var r = e.getOption("configureMouse"), r = r ? r(e, t, n) : {};
            {
                var i;
            ...
            var o = t.display, l = !1, s = R(t, function (e) {
            ...
            function s(e) {
                if (0 != P(b, e)) if (b = e, "rectangle" == p.unit) {
            ...
            var r = R(d, function (e) {
                (0 !== e.buttons && Ze(e) ? function e(t) {
                    var n, r, i = ++u, o = fr(d, t, !0, "rectangle" == p.unit);
    ...
    function p(e, t) {
        ...
        function h(e, t) {
            ...
            var n = t.left - e.left, t = t.top - e.top;
            return 400 < n * n + t * t
        }
    ...
    function yl(e, t, n, r) {
        var i, o = e.doc,
            ...
            s = W(o, t), a = S(s.text, null, l), u = (s.stateAfter && (s.stateAfter = null), s.text.match(/^\s*/)[0]);
        if (r || /\S/.test(s.text)) {
        ...
        if (e.options.indentWithTabs) for (var f = Math.floor(c / l); f; --f) d += l, h += "\t";
    ...
    function xl(e, t, n, r, i) {
        var o = e.doc, l = (e.display.shift = !1, r = r || o.sel, +new Date - 200),
            s = "paste" == i || e.state.pasteIncoming > l, a = tt(t), u = null;
        if (s && 1 < r.ranges.length) if (bl && bl.text.join("\n") == t) {
            if (r.ranges.length % bl.text.length == 0) for (var u = [], c = 0; c < bl.text.length; c++) u.push(o.splitLines(bl.text[c]))
    ...
    function Ll(e) {
        for (var t = [], n = [], r = 0; r < e.doc.sel.ranges.length; r++) {
            var i = e.doc.sel.ranges[r].head.line, i = {anchor: F(i, 0), head: F(i + 1, 0)};
    ...
    function Ml(n, r, i, o, l) {
        var e = r, t = i, s = W(n, r.line), a = l && "rtl" == n.direction ? -i : i;
        ...
        if ("char" == o || "codepoint" == o) u(); else if ("column" == o) u(!0); else if ("word" == o || "group" == o) for (var c = null, h = "group" == o, d = n.cm && n.cm.getHelper(r, "wordChars"), f = !0; !(i < 0) || u(!f); f = !1) {
    ...
    function Nl(e, t, n, r) {
        ...
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, ue(e).innerHeight || s(e).documentElement.clientHeight), i = Math.max(i - .5 * sr(e.display), 3), o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3); (l = tr(e, a, o)).outside;) {
    ...
    function Ol(e, t) {
        ...
        var r = W(e.doc, t.line), n = Pn(n, r, t.line), r = Ge(r, e.doc.direction), e = "left",
    ...
    function Dl(e, t, n) {
        ...
        for (var i = 0; i < e.display.view.length; i++) {
            ...
            if (o.node == r) {
                var u = o, o = t, l = n, s = u.text.firstChild, a = !1;
                if (!o || !re(s, o)) return Al(F(H(u.line), 0), !0);
                if (o == s) if (a = !0, o = s.childNodes[l], l = 0, !o) return Al(F(H(c = u.rest ? z(u.rest) : u.line), c.text.length), a);
                var c = 3 == o.nodeType ? o : null, h = o;
                for (c || 1 != o.childNodes.length || 3 != o.firstChild.nodeType || (c = o.firstChild, l = l && c.nodeValue.length); h.parentNode != s;) h = h.parentNode;
                var d = u.measure, f = d.maps;

                function p(e, t, n) {
                    for (var r = -1; r < (f ? f.length : 0); r++) for (var i = r < 0 ? d.map : f[r], o = 0; o < i.length; o += 3) {
                        var l, s, a = i[o + 2];
    ...
    r.prototype.init = function (e) {
        ...
        function n(e) {
            if (a(e) && !A(l, e)) {
                if (l.somethingSelected()) wl({
                    ...
                    var t = Ll(l);
                    wl({lineWise: !0, text: t.text}), "cut" == e.type && l.operation(function () {
        ...
        var e = this.getSelection(), t = this.cm, n = t.doc.sel.primary(), r = n.from(), n = n.to();
        if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || n.line < t.display.viewFrom) e.removeAllRanges(); else {
            var i = Dl(t, e.anchorNode, e.anchorOffset), o = Dl(t, e.focusNode, e.focusOffset);
            if (!i || i.bad || !o || o.bad || 0 != P(St(i, o), r) || 0 != P(Ct(i, o), n)) {
                var i = t.display.view,
                    o = r.line >= t.display.viewFrom && Ol(t, r) || {node: i[0].measure.map[2], offset: 0},
        ...
        var o,
            l = i.line == n.viewFrom || 0 == (l = pr(t, i.line)) ? (e = H(n.view[0].line), n.view[0].node) : (e = H(n.view[l].line), n.view[l - 1].node.nextSibling),
            r = pr(t, r.line),
        ...
        for (var s = t.doc.splitLines(function (o, e, t, l, s) {
            var n = "", a = !1, u = o.doc.lineSeparator(), c = !1;
            ...
            for (; !function e(t) {
                if (1 == t.nodeType) {
                    ...
                    if (n) d(n); else if (n = t.getAttribute("cm-marker")) (n = o.findMarks(F(l, 0), F(s + 1, 0), (i = +n, function (e) {
                        return e.id == i
                    }))).length && (n = n[0].find(0)) && d(pt(o.doc, n.from, n.to).join(u)); else if ("false" != t.getAttribute("contenteditable") && (n = /^(pre|div|p|li|table|br)$/i.test(t.nodeName), /^br$/i.test(t.nodeName) || 0 != t.textContent.length)) {
                        n && h();
            ...
            return n
        }(t, l, n, e, o)), a = pt(t.doc, F(e, 0), F(o, W(t.doc, o).text.length)); 1 < s.length && 1 < a.length;) if (z(s) == z(a)) s.pop(), a.pop(), o--; else {
            if (s[0] != a[0]) break;
            s.shift(), a.shift(), e++
        }
        ...
        if (1 == s.length && 1 == a.length && e == i.line) for (; u && u > i.ch && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1);) u--, c++;
    ...
    i.prototype.init = function (n) {
        var e = this, r = this, i = this.cm, o = (this.createField(n), this.textarea);

        function t(e) {
            if (!A(i, e)) {
                if (i.somethingSelected()) wl({lineWise: !1, text: i.getSelections()}); else {
        ...
        var e, t = this.cm, n = t.display, r = t.doc, i = wr(t);
        ...
        var n, r, t, i, o = this, l = o.cm, s = l.display, a = o.textarea,
            u = (o.contextMenuPending && o.contextMenuPending(), fr(l, e)), c = s.scroller.scrollTop;
    ...
    }, i.prototype.needsContentAttribute = !1, Hl = (Wl = p).optionHandlers, Wl.defineOption = o, Wl.Init = dl, o("value", "", function (e, t) {
        return e.setValue(t)
        ...
        indentSelection: t(function (e) {
            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                var i = t[r];
                if (i.empty()) i.head.line > n && (yl(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && Hr(this)); else {
        ...
        getTokenTypeAt: function (e) {
            e = E(this.doc, e);
            var t, n = Ot(this, W(this.doc, e.line)), r = 0, i = (n.length - 1) / 2, o = e.ch;
        ...
        lineAtHeight: function (e, t) {
            return e = qn(this, {top: e, left: 0}, t || "page").top, vt(this.doc, e + this.display.viewOffset)
        },
        heightAtLine: function (e, t, n) {
            var r = !1,
                i = "number" == typeof e ? (i = this.doc.first + this.doc.size - 1, e < this.doc.first ? e = this.doc.first : i < e && (e = i, r = !0), W(this.doc, e)) : e;
            return _n(this, i, {top: 0, left: 0}, t || "page", n || r).top + (r ? this.doc.height - rn(i) : 0)
        },
        ...
        addWidget: function (e, t, n, r, i) {
            var o, l, s = this.display, a = (e = Qn(this, E(this.doc, e))).bottom, u = e.left;
        ...
        moveV: t(function (r, i) {
            ...
            }, ve), s.length) for (var e = 0; e < l.sel.ranges.length; e++) l.sel.ranges[e].goalColumn = s[e]
        }),
        findWordAt: function (e) {
            var t = W(this.doc, e.line).text, n = e.ch, r = e.ch;
            if (t) {
    ...
    return Xe(f), p.inputStyles = {textarea: i, contenteditable: r}, p.defineMode = function (e) {
        p.defaults.mode || "null" == e || (p.defaults.mode = e), function (e, t) {
